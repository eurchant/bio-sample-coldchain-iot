...
第一阶段后端 MVP 已完成并通过本地验收，Web 管理端和微信小程序仍在开发中。
...
| tkx | PC Web 管理端 | `tkx` |
| ljy | 微信小程序公共底座、任务和发出交接 | `ljy` |
| zrq | 微信小程序监控、告警、签收和追溯测试 | `zrq` |

- `main`：稳定、可演示版本
- `zy`：后端和项目管理
- `tkx`：PC Web 管理端
- `ljy`：微信小程序公共底座、任务和发出交接
- `zrq`：微信小程序监控、告警、签收和追溯测试
...
当前阶段：硬件原型、基础软硬件闭环和第一阶段后端 MVP 已完成，Web 管理端和微信小程序正在开发。
